...
$data = $gov->single_fetch('institution',1);
      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page"> 
            <h1 style="font-size:22px;text-align:center;"><p style="color:#D083CF">History of Institution</p></h1><br>
            <div class=""> 
             <p style="text-align:justify;"><?php echo $data['history'] ?></p>
            </div>
