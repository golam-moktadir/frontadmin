       ...
       <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="review-content-section">
            <form action="view/front/speech/store_president_speech.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add President Message </h3>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="speech" required placeholder="Write message here"></textarea>
                        </div>
                    </div>
               </div>
                <div class="row">
