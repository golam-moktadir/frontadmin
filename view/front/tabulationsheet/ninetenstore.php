...
$results = $tabulation->selectAllNineTen($class, $term, $year);
...
?>
	<div class="row">
		<div class="col-md-12">
			<div class="form-group" style="text-align:right;">
				<a class="btn btn-success" href="view/admin/tabulationsheet/nineten.php">Search Again</a>
			</div>
		</div>
	</div>
    <div class="container" id="printableArea" >
        ...
        <div class="row" >
	            ...
	            <p style="text-align:center;">ডাকঘরঃ বগুড়া , উপজেলাঃ বগুড়া সদর, জেলাঃ বগুড়া ।</p>
 ...
 <br>
    ...
    <table border="1" align="center" width="100%" style="background: white; font-size: 12px">
        ...
        <tr>
            <td colspan="22" align="center" style="background: #56ABEE;">মার্কসশীট</td>
        </tr>
