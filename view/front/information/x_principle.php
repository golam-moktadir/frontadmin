...
$value = $gov->multi_fetch('speech',13);
...
<section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
          <h2 style="color:#D083CF"><center>Former Principles</center></h2><br>
            <div class="box-body" >
                <table style="border:1px solid #D083CF" id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><img src="view/front/uploads/speech/<?php echo $data['image'] ?>" width="120" height="150" /></td>
                   </tr>
                     <?php } ?>
