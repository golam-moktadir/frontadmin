...
$value = $gov->multi_fetch('result',1);
...
<section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
          <h2 style="color:#D083CF"><center>Examination Result</center></h2><br>
            <div class="box-body" >
                <table style="border:1px solid #D083CF" id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="view/front/uploads/result/<?php echo $data['image'] ?>" target="_blank"><img width="80" height="80" src="view/front/uploads/icon/pdf.jpg"></a></td>
                   </tr>
                     <?php } ?>
