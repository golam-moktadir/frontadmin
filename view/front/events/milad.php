      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
          <div class="single_page">
           ...
           <h1 style="font-size:22px;text-align:center;color:#D083CF">Milad Mahfil</h1>
           <!--  <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i>FUPHS</a> <span><i class="fa fa-calendar"></i><?php echo date('y:m:h') ?></span> <a href="#"><i class="fa fa-tags"></i>Info</a> </div> -->
            <div class="">
            <br>
             <img class="img-center img-rounded" width="250 " height="220" src="view/front/uploads/milad/<?php echo $data['image'] ?>" alt="">
             <br>
                <p style="text-align:justify;"><?php echo $data['milad'] ?></p>
            </div>
