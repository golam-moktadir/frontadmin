       ...
       <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="review-content-section">  
            ...
            <form action="view/front/sports/store_sports.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="sports" required placeholder="Write message here"></textarea>
                        </div>
                    </div>  
                </div>
                <div class="row">
