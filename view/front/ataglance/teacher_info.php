...
$value = $gov->multi_fetch('teacher_data',1);
...
<section id="contentSection">
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
          <h2 style="color:#D083CF"><center>Teachers Information</center></h2><br>
            <div class="box-body" >
                    ...
                    ?>
                       <tr>
                           <td><?php echo $i++?></td>
                            ...
                            <td>
                                <img src="view/front/uploads/teacher/<?php echo $data['image'] ?>" width="120" height="150"  alt="">
                            </td>
