      ...
      <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="review-content-section">
            <form action="view/front/holiday/store_holiday.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Holiday List</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""> Title :<font color="red" size="4">*</font> </label>
                            <input name="routine" class="form-control" required placeholder="Enter Title">
                        </div>
                    </div>  
                </div>
                <div class="row">
