       ...
       <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="review-content-section">   
            <form action="view/front/law/store_law.php" method="post" enctype="multipart/form-data">
                <h3 class="text-center" style="color: #2559ee">Add New Law</h3>
                <hr /> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for=""> Law :<font color="red" size="4">*</font> </label>
                            <input type='text' id="" name="law" class="form-control" placeholder="Enter New Law" required />
                        </div>
                    </div>  
                </div>
                <div class="row">
